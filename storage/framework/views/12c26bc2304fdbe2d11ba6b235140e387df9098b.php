  ...
  <div class="custom-scroll custom-scroll-light">
    <ul class="sidebar-menu">
      ...
      <li class="with-sub">
        ...
        <ul>
          <li><a href="<?php echo e(route('dailySalesList')); ?>">فروشات روزانه</a></li>
          <li><a href="<?php echo e(route('addCompanyAdmin')); ?>">ثبت شرکت جدید</a></li>
          <li><a href="<?php echo e(route('doDealsAdmin')); ?>">اجرای معاملات </a></li>
          <li><a href="<?php echo e(route('companyBlanceAdmin')); ?>">بیلانس شرکت ها (قروض)</a></li>
          <li><a href="<?php echo e(route('availableDrugAdmin')); ?>">دوای موجود (ارزش دواخانه)</a></li>
        </ul>
      </li>
      ...
      <!-- <li class="with-sub">
        ...
        <ul>
          <li><a href="<?php echo e(route('addCompanyLab')); ?>">ثبت شرکت جدید</a></li>
          <li><a href="<?php echo e(route('doDealsLab')); ?>">اجرای معاملات </a></li>
          <li><a href="<?php echo e(route('companyBlanceLab')); ?>">بیلانس شرکت ها (قروض)</a></li>
          <li><a href="/asset">وسایل</a></li>
          <li><a href="<?php echo e(route('availableDrugLab')); ?>">بیلانس کلی</a></li>
        </ul>
      </li>
      ...
      <li class="with-sub">
        ...
        <ul>
          <li><a href="<?php echo e(route('addCompanyDental')); ?>">ثبت شرکت جدید</a></li>
          <li><a href="<?php echo e(route('doDealsDental')); ?>">اجرای معاملات </a></li>
          <li><a href="<?php echo e(route('companyBlanceDental')); ?>">بیلانس شرکت ها (قروض)</a></li>
          <li><a href="/assets">وسایل</a></li>
          <li><a href="<?php echo e(route('availableDrugDental')); ?>">بیلانس کلی</a></li>
        </ul>
      </li> -->
